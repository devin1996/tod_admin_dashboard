...
function bookingFromSearch() {
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("bookingFromSearch");
    filter = input.value.toUpperCase();
    table = document.getElementById("tableBusBooking");
...
function bookingToSearch() {
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("bookingToSearch");
    filter = input.value.toUpperCase();
    table = document.getElementById("tableBusBooking");
    tr = table.getElementsByTagName("tr");
